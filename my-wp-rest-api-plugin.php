<?php
/*
     * Plugin Name:  MY WP REST API PLUGIN
...
class My_REST_Posts_Controller
{
    ...
    {   $this->wpjsonstring = '/wp-json';
        ...
        add_action('wp_enqueue_scripts', array($this, 'my_wp_rest_api_js'));
    ...
    function my_wp_rest_api_js()
    {
        wp_enqueue_script('main-js', plugins_url('/js/main.js', __FILE__), array(), false, true);
